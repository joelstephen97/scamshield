(function (root, factory) {
  ...
  const B = (key, names, domains, opts) => Object.assign({ key, names, domains, nameMatch: true, ccPolicy: 'open' }, opts || {});
  const BRANDS_HAND = [
    ...
    B('chase', ['chase bank', 'jpmorgan'], ['chase.com', 'jpmorgan.com'], { nameMatch: false }),
  ...
  const BRANDS_GENERATED = [
    B('discord', ['discord'], ['discord.com', 'discordapp.com', 'discord.gg', 'discord.media'], { display: 'Discord', ccPolicy: 'closed', suffixes: ['com', 'gg', 'media'] }),
    ...
    B('kraken', ['kraken'], ['kraken.com'], { display: 'Kraken', ccPolicy: 'closed', suffixes: ['com'] }),
    ...
    B('regions', ['regions bank'], ['regions.com'], { display: 'Regions Bank' }),
    B('fifththird', ['fifth third'], ['53.com'], { display: 'Fifth Third Bank' }),
    B('keybank', ['keybank'], ['key.com'], { display: 'KeyBank' }),
    B('discover', ['discover card'], ['discover.com'], { display: 'Discover' }),
    ...
    B('chime', ['chime bank'], ['chime.com'], { display: 'Chime' }),
    ...
    B('popular', ['banco popular'], ['popular.com'], { display: 'Banco Popular' }),
    ...
    B('zurich', ['zurich insurance'], ['zurich.com'], { display: 'Zurich Insurance' }),
    ...
    B('target', ['target stores'], ['target.com'], { display: 'Target' }),
    ...
    B('olx', ['olx'], ['olx.com', 'olx.pl'], { display: 'OLX' }),
    ...
    B('orange', ['orange telecom'], ['orange.fr'], { display: 'Orange' }),
    ...
    B('three', ['three mobile'], ['three.co.uk'], { display: 'Three' }),
    ...
    B('smart', ['smart communications'], ['smart.com.ph'], { display: 'Smart Communications' }),
    ...
    B('slack', ['slack'], ['slack.com'], { display: 'Slack' }),
    B('salesforce', ['salesforce'], ['salesforce.com'], { display: 'Salesforce' }),
    B('workday', ['workday'], ['workday.com'], { display: 'Workday' }),
    ...
    B('notion', ['notion'], ['notion.so'], { display: 'Notion' }),
    ...
    B('stripe', ['stripe'], ['stripe.com'], { display: 'Stripe' }),
    B('square', ['square inc'], ['squareup.com'], { display: 'Square' }),
    B('wetransfer', ['wetransfer'], ['wetransfer.com'], { display: 'WeTransfer' }),
    B('twitch', ['twitch'], ['twitch.tv'], { display: 'Twitch' }),
    ...
    B('nintendo', ['nintendo'], ['nintendo.com'], { display: 'Nintendo' }),
    B('playstation', ['playstation'], ['playstation.com'], { display: 'PlayStation' }),
    ...
    B('affirm', ['affirm pay'], ['affirm.com'], { display: 'Affirm' }),
    B('opensea', ['opensea'], ['opensea.io'], { display: 'OpenSea' }),
    B('twitter', ['twitter'], ['twitter.com', 'x.com'], { display: 'Twitter (X)' }),
    B('tiktok', ['tiktok'], ['tiktok.com', 'tiktokv.com'], { display: 'TikTok' }),
    ...
    B('exodus', ['exodus wallet'], ['exodus.com'], { display: 'Exodus Wallet' }),
    B('trustwallet', ['trust wallet'], ['trustwallet.com'], { display: 'Trust Wallet' }),
    B('uniswap', ['uniswap'], ['uniswap.org'], { display: 'Uniswap' }),
    B('gemini', ['gemini exchange'], ['gemini.com'], { display: 'Gemini Exchange' }),
    ...
    B('united', ['united airlines'], ['united.com'], { display: 'United Airlines' }),
    B('americanairlines', ['american airlines'], ['aa.com'], { display: 'American Airlines' }),
    B('southwest', ['southwest airlines'], ['southwest.com'], { display: 'Southwest Airlines' }),
    ...
    B('garuda', ['garuda indonesia'], ['garuda-indonesia.com'], { display: 'Garuda Indonesia' }),
    B('airasia', ['airasia'], ['airasia.com'], { display: 'AirAsia' }),
    B('scoot', ['scoot airlines'], ['flyscoot.com'], { display: 'Scoot' }),
    B('vistara', ['vistara'], ['airvistara.com'], { display: 'Vistara' }),
    B('indigo', ['indigo airlines'], ['goindigo.in'], { display: 'IndiGo' }),
    B('indeed', ['indeed jobs'], ['indeed.com'], { display: 'Indeed' }),
    ...
    B('grammarly', ['grammarly'], ['grammarly.com'], { display: 'Grammarly' }),
    B('evernote', ['evernote'], ['evernote.com'], { display: 'Evernote' }),
    B('trello', ['trello'], ['trello.com'], { display: 'Trello' }),
    B('asana', ['asana'], ['asana.com'], { display: 'Asana' }),
    ...
    B('concur', ['sap concur'], ['concur.com'], { display: 'SAP Concur' }),
    B('expensify', ['expensify'], ['expensify.com'], { display: 'Expensify' }),
    B('greenhouse', ['greenhouse.io'], ['greenhouse.io'], { display: 'Greenhouse' }),
    B('lever', ['lever.co'], ['lever.co'], { display: 'Lever' }),
