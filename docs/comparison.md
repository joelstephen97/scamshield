...
disclosure, read live on 2026-08-29. Where a rival's own listing doesn't
...
| Crypto wallet-drainer guard | Yes — warns on risky approvals and blind signatures, blocks recovery-phrase theft | — | — | — | — | — | — | — | — |
| Tech-support-scam blocking | Yes — full-screen interstitial for "your PC is infected, call now" pages | — | — | — | — | — | — | — | — |
...
| Processing location | 100% on-device | Cloud | Cloud-assisted | Cloud (Remote URL Reputation Service) | — | Cloud (explicit page scan) | Cloud blocklists + local heuristics (hybrid) | Cloud | Cloud (trust-score lookup) |
| Price | Free, no premium tier | Free tier limited; $9.99–$34.99/mo for real-time blocking, download protection and leak monitoring | Free | — | — | Free (cross-sell to paid suite) | — | — | — |
