...
| Threat feed ([scamshield-feed](https://github.com/joelstephen97/parry-feed)) | ✅ |
...
- **Privacy regressions** — any network request that leaks browsing data, page text, URL paths, or identifiers, or any way to make reporting fire while the opt-in is off. The only permitted network activity is listed in the [README](README.md#privacy) and the [privacy policy](https://joelstephen97.github.io/parry/privacy.html).
...
- Detection misses or false positives that are not bypasses of a *guard* — those are normal bugs; please use **Report a mistake** in the extension or [open an issue](https://github.com/joelstephen97/parry/issues/new).
