<!--
  Staging file for Task 7. Two FAQ entries, written in the same plain
  store-listing prose used in store/listings/en.md. A later listing task
  merges these into store/listings/en.md's FAQ section (and the translated
  locale files) — do not merge them here.

  Source: .superpowers/sdd/ancient-dreaming-breeze/research-listing-playbook.md
  ("Comparison matrix source data"), figures as of 2026-08-29.
-->
