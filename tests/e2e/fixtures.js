  ...
  context: async ({}, use) => {
    ...
    const context = await chromium.launchPersistentContext('', {
      ...
      args: [
        ...
        '--host-resolver-rules=MAP amazon.ae 127.0.0.1, MAP accounts.google.com 127.0.0.1, MAP shop.contoso-fixture.com 127.0.0.1, MAP portal-hr-benefits.fixture 127.0.0.1, MAP www.aramex.com 127.0.0.1, MAP secure-paypa1-login.com 127.0.0.1, MAP www.google.com 127.0.0.1, MAP block-feed-fixture.example 127.0.0.1, MAP warn-feed-fixture.example 127.0.0.1, MAP fp-feed-fixture.example 127.0.0.1, MAP clean-feed-fixture.example 127.0.0.1'
      ]
    });
